 ...
 */
public class GMServerSetImpl implements GMServerSet {
   ...
   */
  public GMServerSetImpl(ZooKeeperClient zkClient, String path) {
   ...
   * @param path the name-service path of the service to connect to
   */
  public GMServerSetImpl(ZooKeeperClient zkClient, Iterable<ACL> acl, String path) {
   ...
   */
  public GMServerSetImpl(ZooKeeperClient zkClient, Group group) {
   ...
   *     from a byte array
   */
  public GMServerSetImpl(ZooKeeperClient zkClient, Group group, Codec<ServiceInstance> codec) {
  ...
  private class MemberStatus {
    ...
    byte[] serializeServiceInstance() {
      ServiceInstance serviceInstance = new ServiceInstance(
          GMServerSets.toEndpoint(endpoint),
          Maps.transformValues(additionalEndpoints, GMServerSets.TO_ENDPOINT),
          Status.ALIVE);
      ...
      try {
        return GMServerSets.serializeServiceInstance(serviceInstance, codec);
      } catch (IOException e) {
