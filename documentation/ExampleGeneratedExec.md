...
### Output generated
    ...
    Downloading: http://repo.maven.apache.org/maven2/com/deciphernow/gm-fabric-archetype/0.1.0/maven-metadata.xml
    
    Downloading: http://repo.maven.apache.org/maven2/com/deciphernow/gm-fabric/0.1.0/maven-metadata.xml
    ...
    [INFO] Using property: serviceFrameworkVersion = 0.1.0
    ...
    serviceFrameworkVersion: 0.1.0
     Y: : Y
    [INFO] ----------------------------------------------------------------------------
    [INFO] Using following parameters for creating project from Archetype: gm-fabric-archetype:0.1.0
    [INFO] ----------------------------------------------------------------------------
    ...
    [INFO] Parameter: serviceFrameworkVersion, Value: 0.1.0
    [INFO] Parameter: package, Value: com.somepackage
    [INFO] Parameter: version, Value: 0.1.0
    [INFO] Parameter: groupId, Value: com.somepackage
    [INFO] Parameter: artifactId, Value: myfirstmicroservice
...
### Compiled output
    ...
    [INFO] Scanning for projects...
    [WARNING] 
    [WARNING] Some problems were encountered while building the effective model for com.somepackage:myfirstmicroservice-business:jar:0.1.0
    ...
    [WARNING] 
    [WARNING] Some problems were encountered while building the effective model for com.somepackage:myfirstmicroservice-client:jar:0.1.0
    ...
    [WARNING] 
    [WARNING] Some problems were encountered while building the effective model for com.somepackage:myfirstmicroservice-server:jar:0.1.0
    ...
    [INFO]                                                                         
    [INFO] ------------------------------------------------------------------------
    [INFO] Building myfirstmicroservice 0.1.0
    [INFO] ------------------------------------------------------------------------
    [INFO] 
    [INFO] --- maven-clean-plugin:2.5:clean (default-clean) @ myfirstmicroservice ---
    [INFO]                                                                         
    [INFO] ------------------------------------------------------------------------
    [INFO] Building myfirstmicroservice-business 0.1.0
    [INFO] ------------------------------------------------------------------------
    [INFO] 
    ...
    [INFO] Building jar: /home/user/dev/workspaces/ms/myfirstmicroservice/business/target/myfirstmicroservice-business-0.1.0.jar
    [INFO]                                                                         
    [INFO] ------------------------------------------------------------------------
    [INFO] Building myfirstmicroservice-model 0.1.0
    [INFO] ------------------------------------------------------------------------
    [INFO] 
    ...
    [INFO] Building jar: /home/user/dev/workspaces/ms/myfirstmicroservice/model/target/myfirstmicroservice-model-0.1.0.jar
    [INFO]                                                                         
    [INFO] ------------------------------------------------------------------------
    [INFO] Building myfirstmicroservice-client 0.1.0
    [INFO] ------------------------------------------------------------------------
    [INFO] 
    ...
    [INFO] Building jar: /home/user/dev/workspaces/ms/myfirstmicroservice/client/target/myfirstmicroservice-client-0.1.0.jar
    [INFO]                                                                         
    [INFO] ------------------------------------------------------------------------
    [INFO] Building myfirstmicroservice-server 0.1.0
    [INFO] ------------------------------------------------------------------------
    ...
    [INFO] Building jar: /home/user/dev/workspaces/ms/myfirstmicroservice/server/target/myfirstmicroservice-server-0.1.0.jar
    [INFO] 
    ...
    [INFO] Installing artifact /home/user/.m2/repository/com/deciphernow/gm-fabric-core/0.1.0/gm-fabric-core-0.1.0.jar to /home/user/dev/workspaces/ms/myfirstmicroservice/server/target/appassembler/jsw/myfirstmicroservice-server/lib/gm-fabric-core-0.1.0.jar
    ...
    [INFO] Installing artifact /home/user/dev/workspaces/ms/myfirstmicroservice/model/target/myfirstmicroservice-model-0.1.0.jar to /home/user/dev/workspaces/ms/myfirstmicroservice/server/target/appassembler/jsw/myfirstmicroservice-server/lib/myfirstmicroservice-model-0.1.0.jar
    ...
    [INFO] Installing artifact /home/user/dev/workspaces/ms/myfirstmicroservice/business/target/myfirstmicroservice-business-0.1.0.jar to /home/user/dev/workspaces/ms/myfirstmicroservice/server/target/appassembler/jsw/myfirstmicroservice-server/lib/myfirstmicroservice-business-0.1.0.jar
    ...
    [INFO] Installing artifact /home/user/dev/workspaces/ms/myfirstmicroservice/server/target/myfirstmicroservice-server-0.1.0.jar to /home/user/dev/workspaces/ms/myfirstmicroservice/server/target/appassembler/jsw/myfirstmicroservice-server/lib/myfirstmicroservice-server-0.1.0.jar
    [INFO] 
    [INFO] --- maven-assembly-plugin:2.5.2:single (default) @ myfirstmicroservice-server ---
    [INFO] Building tar: /home/user/dev/workspaces/ms/myfirstmicroservice/server/target/myfirstmicroservice-server-0.1.0-app.tgz
    [INFO] Copying files to /home/user/dev/workspaces/ms/myfirstmicroservice/server/target/myfirstmicroservice-server-0.1.0-app
    [INFO] ------------------------------------------------------------------------
...
## Executing MyFirstMicroservice
    ...
    $ server/target/myfirstmicroservice-server-0.1.0-app/myfirstmicroservice-server-0.1.0/bin/myfirstmicroservice-server console
...
### Execution output
    ...
    jvm 1    | SLF4J: Found binding in [jar:file:/home/user/dev/workspaces/ms/myfirstmicroservice/server/target/myfirstmicroservice-server-0.1.0-app/myfirstmicroservice-server-0.1.0/lib/logback-classic-1.1.2.jar!/org/slf4j/impl/StaticLoggerBinder.class]
    jvm 1    | SLF4J: Found binding in [jar:file:/home/user/dev/workspaces/ms/myfirstmicroservice/server/target/myfirstmicroservice-server-0.1.0-app/myfirstmicroservice-server-0.1.0/lib/slf4j-log4j12-1.7.5.jar!/org/slf4j/impl/StaticLoggerBinder.class]
